-- 20. The name, population, area, and population density (name the column 'population_density') of 
-- states, territories, and districts with more than 100 people per square kilometer (12 rows)
