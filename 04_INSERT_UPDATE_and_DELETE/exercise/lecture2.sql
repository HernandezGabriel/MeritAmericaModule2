...
values( 'Hawkins', 30000, 14.71, 'IN'), ('Cicely', 839, 4.39, 'AK' );
...
-- Change Californias nickname back to "The Golden State", reduce the population by 1,000,000, and change the capital back to Sacramento.
...
-- UNIQUE constraint
-- Try changing Californias nickname to "Vacationland" (which is already the nickname of Maine).
